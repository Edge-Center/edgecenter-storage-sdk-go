...
func (o *StorageDeleteHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /resource/v3/storage/{id}] storageDeleteHttp", response, response.Code())
	}
}
...
func (o *StorageDeleteHTTPNoContent) Error() string {
	return fmt.Sprintf("[DELETE /resource/v3/storage/{id}][%d] storageDeleteHttpNoContent ", 204)
}
...
func (o *StorageDeleteHTTPBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /resource/v3/storage/{id}][%d] storageDeleteHttpBadRequest  %+v", 400, o.Payload)
}
