...
func (o *StorageGetHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /resource/v3/storage/{id}] storageGetHttp", response, response.Code())
	}
}
...
func (o *StorageGetHTTPOK) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}][%d] storageGetHttpOK  %+v", 200, o.Payload)
}
...
func (o *StorageGetHTTPBadRequest) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}][%d] storageGetHttpBadRequest  %+v", 400, o.Payload)
}
