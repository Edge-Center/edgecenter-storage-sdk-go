...
func (o *StorageRestoreHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /resource/v3/storage/{id}/restore] storageRestoreHttp", response, response.Code())
	}
}
...
func (o *StorageRestoreHTTPNoContent) Error() string {
	return fmt.Sprintf("[POST /resource/v3/storage/{id}/restore][%d] storageRestoreHttpNoContent ", 204)
}
...
func (o *StorageRestoreHTTPBadRequest) Error() string {
	return fmt.Sprintf("[POST /resource/v3/storage/{id}/restore][%d] storageRestoreHttpBadRequest  %+v", 400, o.Payload)
}
