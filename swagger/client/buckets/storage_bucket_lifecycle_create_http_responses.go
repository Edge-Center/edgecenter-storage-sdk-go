...
func (o *StorageBucketLifecycleCreateHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[POST /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle] storageBucketLifecycleCreateHttp", response, response.Code())
	}
}
...
func (o *StorageBucketLifecycleCreateHTTPNoContent) Error() string {
	return fmt.Sprintf("[POST /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle][%d] storageBucketLifecycleCreateHttpNoContent ", 204)
}
...
func (o *StorageBucketLifecycleCreateHTTPBadRequest) Error() string {
	return fmt.Sprintf("[POST /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle][%d] storageBucketLifecycleCreateHttpBadRequest  %+v", 400, o.Payload)
}
