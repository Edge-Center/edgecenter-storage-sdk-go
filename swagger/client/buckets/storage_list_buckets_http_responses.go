...
func (o *StorageListBucketsHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /resource/v3/storage/{id}/s3/buckets] storageListBucketsHttp", response, response.Code())
	}
}
...
func (o *StorageListBucketsHTTPOK) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}/s3/buckets][%d] storageListBucketsHttpOK  %+v", 200, o.Payload)
}
...
func (o *StorageListBucketsHTTPBadRequest) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}/s3/buckets][%d] storageListBucketsHttpBadRequest  %+v", 400, o.Payload)
}
