...
func (o *StorageBucketLifecycleDeleteHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle] storageBucketLifecycleDeleteHttp", response, response.Code())
	}
}
...
func (o *StorageBucketLifecycleDeleteHTTPNoContent) Error() string {
	return fmt.Sprintf("[DELETE /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle][%d] storageBucketLifecycleDeleteHttpNoContent ", 204)
}
...
func (o *StorageBucketLifecycleDeleteHTTPBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /resource/v3/storage/{id}/s3/bucket/{name}/lifecycle][%d] storageBucketLifecycleDeleteHttpBadRequest  %+v", 400, o.Payload)
}
