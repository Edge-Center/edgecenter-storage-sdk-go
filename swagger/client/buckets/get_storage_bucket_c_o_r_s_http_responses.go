...
func (o *GetStorageBucketCORSHTTPReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 400:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /resource/v3/storage/{id}/s3/bucket/{name}/cors] getStorageBucketCORSHttp", response, response.Code())
	}
}
...
func (o *GetStorageBucketCORSHTTPOK) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}/s3/bucket/{name}/cors][%d] getStorageBucketCORSHttpOK  %+v", 200, o.Payload)
}
...
func (o *GetStorageBucketCORSHTTPBadRequest) Error() string {
	return fmt.Sprintf("[GET /resource/v3/storage/{id}/s3/bucket/{name}/cors][%d] getStorageBucketCORSHttpBadRequest  %+v", 400, o.Payload)
}
