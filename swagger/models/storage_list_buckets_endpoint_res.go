...
func (m *StorageListBucketsEndpointRes) validateData(formats strfmt.Registry) error {
...
func (m *StorageListBucketsEndpointRes) validateMeta(formats strfmt.Registry) error {
...
func (m *StorageListBucketsEndpointRes) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageListBucketsEndpointRes) UnmarshalBinary(b []byte) error {
	var res StorageListBucketsEndpointRes
