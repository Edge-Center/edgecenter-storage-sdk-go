...
func (m *ClientListServiceRes) validateClients(formats strfmt.Registry) error {
...
func (m *ClientListServiceRes) contextValidateClients(ctx context.Context, formats strfmt.Registry) error {
