...
func (m *StorageUsageSeriesEndpointRes) validateData(formats strfmt.Registry) error {
...
func (m *StorageUsageSeriesEndpointRes) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageUsageSeriesEndpointRes) UnmarshalBinary(b []byte) error {
	var res StorageUsageSeriesEndpointRes
