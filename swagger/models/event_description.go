...
func (m *EventDescription) validateFields(formats strfmt.Registry) error {
...
func (m *EventDescription) contextValidateFields(ctx context.Context, formats strfmt.Registry) error {
