...
func (m *StorageListEndpointRes) validateData(formats strfmt.Registry) error {
...
func (m *StorageListEndpointRes) validateMeta(formats strfmt.Registry) error {
...
func (m *StorageListEndpointRes) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *StorageListEndpointRes) UnmarshalBinary(b []byte) error {
	var res StorageListEndpointRes
